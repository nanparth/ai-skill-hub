...
Reference catalogue of common code smells with before/after diff examples. Load when identifying or explaining code smells during a refactoring session.

## Contents

1. [Long Method/Function](#1-long-methodfunction)
2. [Duplicated Code](#2-duplicated-code)
3. [Large Class/Module](#3-large-classmodule)
4. [Long Parameter List](#4-long-parameter-list)
5. [Feature Envy](#5-feature-envy)
6. [Primitive Obsession](#6-primitive-obsession)
7. [Magic Numbers/Strings](#7-magic-numbersstrings)
8. [Nested Conditionals](#8-nested-conditionals)
9. [Dead Code](#9-dead-code)
10. [Inappropriate Intimacy](#10-inappropriate-intimacy)
11. [Extract Method Refactoring](#extract-method-refactoring)
12. [Introducing Type Safety](#introducing-type-safety)
...
For a deeper strategy on replacing primitives and weak types with parsed
representations that carry their validation proof, see `parse-dont-validate.md`.
